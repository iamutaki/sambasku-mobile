...
class _AuthRemoteDatasource implements AuthRemoteDatasource {
  ...
  Future<ApiResponse<AuthMessageResponseDto>> forgotPassword(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<ApiResponse<AuthMessageResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<AuthMessageResponseDto> _value;
    try {
      _value = ApiResponse<AuthMessageResponseDto>.fromJson(
        _result.data!,
        (json) => AuthMessageResponseDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
