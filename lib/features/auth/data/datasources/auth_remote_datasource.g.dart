...
class _AuthRemoteDatasource implements AuthRemoteDatasource {
  ...
  Future<ApiResponse<ResendOtpResponseDto>> resendOtp(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<ApiResponse<ResendOtpResponseDto>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<ResendOtpResponseDto> _value;
    try {
      _value = ApiResponse<ResendOtpResponseDto>.fromJson(
        _result.data!,
        (json) => ResendOtpResponseDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
