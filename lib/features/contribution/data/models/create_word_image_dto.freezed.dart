...
mixin _$CreateWordImageDto {
 ...
 String get url;@JsonKey(name: 'provider_file_id') String get providerFileId;@JsonKey(name: 'alt_text', includeIfNull: false) String? get altText;@JsonKey(name: 'is_primary') bool get isPrimary;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,url,providerFileId,altText,isPrimary);

@override
String toString() {
  return 'CreateWordImageDto(url: $url, providerFileId: $providerFileId, altText: $altText, isPrimary: $isPrimary)';
}
...
@useResult
$Res call({
 String url,@JsonKey(name: 'provider_file_id') String providerFileId,@JsonKey(name: 'alt_text', includeIfNull: false) String? altText,@JsonKey(name: 'is_primary') bool isPrimary
});
...
/// Create a copy of CreateWordImageDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? url = null,Object? providerFileId = null,Object? altText = freezed,Object? isPrimary = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String url, @JsonKey(name: 'provider_file_id')  String providerFileId, @JsonKey(name: 'alt_text', includeIfNull: false)  String? altText, @JsonKey(name: 'is_primary')  bool isPrimary)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateWordImageDto() when $default != null:
return $default(_that.url,_that.providerFileId,_that.altText,_that.isPrimary);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String url, @JsonKey(name: 'provider_file_id')  String providerFileId, @JsonKey(name: 'alt_text', includeIfNull: false)  String? altText, @JsonKey(name: 'is_primary')  bool isPrimary)  $default,) {final _that = this;
switch (_that) {
case _CreateWordImageDto():
return $default(_that.url,_that.providerFileId,_that.altText,_that.isPrimary);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String url, @JsonKey(name: 'provider_file_id')  String providerFileId, @JsonKey(name: 'alt_text', includeIfNull: false)  String? altText, @JsonKey(name: 'is_primary')  bool isPrimary)?  $default,) {final _that = this;
switch (_that) {
case _CreateWordImageDto() when $default != null:
return $default(_that.url,_that.providerFileId,_that.altText,_that.isPrimary);case _:
  return null;
...
class _CreateWordImageDto implements CreateWordImageDto {
  const _CreateWordImageDto({required this.url, @JsonKey(name: 'provider_file_id') required this.providerFileId, @JsonKey(name: 'alt_text', includeIfNull: false) this.altText, @JsonKey(name: 'is_primary') this.isPrimary = false});
...
/// Create a copy of CreateWordImageDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? url = null,Object? providerFileId = null,Object? altText = freezed,Object? isPrimary = null,}) {
